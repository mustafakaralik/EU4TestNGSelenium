...
public class Singleton {
        //İF YOU WANNA PREVENT TO CREATE OBJECT FROM YOUR CLASS private constructor OBJE İSTEMEZ
    //singleton class will have private constructor
    //it means other classes cannot create object of this class

    private Singleton(){} //private constructor

    private static String str; //private static String variable return string
