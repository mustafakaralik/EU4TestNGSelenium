...
public class MultipleWindows {
    ...
    public void SwitchWindowsTest(){
        ...
        //her sayfanın kendine ait unique bir numarası vardır windowhandle DENİLEN
        String currentWindowHandle = driver.getWindowHandle();

        Set<String> windowHandles = driver.getWindowHandles();
        //BURADA FOR EACH LOOP İLE HER SAYFANIN WİNDOWHANDLE INI ALIP-->İF İLE KIYASLIYORUZ
    ...
    public void moreThan2Window(){
        ...
        for (String handle : windowHandles) {
            ...
            driver.switchTo().window(handle);
            //whenever your title equaşls to your expected window title
